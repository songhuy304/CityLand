...
if ($max_pages > 1) : ?>
                <div class="btn btn-primary mx-auto load-more-posts" data-page="2" data-max="<?php echo esc_attr($max_pages); ?>" data-limit="9" data-tax="<?php echo (is_category()) ? 'category' : ''; ?>" data-term="<?php echo (is_category()) ? get_queried_object_id() : ''; ?>" data-target="post-grid" data-post-type="post">
                    <span>
