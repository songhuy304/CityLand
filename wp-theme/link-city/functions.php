...
function link_city_activate_sample_post()
{
    ...
    $content = <<<'HTML'
<p class="detail-sapo" data-role="sapo"><strong>Với sự đồng hành của Surbana Jurong (Singapore), Kim Oanh Land (thành viên Kim Oanh Group) đã phát triển bộ tiêu chuẩn Singapore áp dụng cho dự án K-Home New City – Đô thị nhà ở xã hội chuẩn Singapore đầu tiên tại Việt Nam.</strong></p>
