...
<body <?php body_class(); ?>>
  ...
  <div class="wrapper" id="wrapper">
        ...
        <div id="masthead" class="header-main">
          ...
          <div class="logo-wrapper">
            <a href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>">
              <img
                src="<?php echo get_template_directory_uri(); ?>/assets/images/Layer_1.svg"
              ...
              <li class="header-search header-search-lightbox has-icon">
                <a
                  ...
                  <svg
                    ...
                    <path
                      d="M20.7055 20L16.9712 16.3056M19.6385 9.97222C19.6385 14.9274 15.5781 18.9444 10.5692 18.9444C5.56044 18.9444 1.5 14.9274 1.5 9.97222C1.5 5.017 5.56044 1 10.5692 1C15.5781 1 19.6385 5.017 19.6385 9.97222Z"
                      stroke="white"
                      stroke-width="1.5"
    ...
    <div
      id="nk-main-menu"
      class="flex-box flex-col jus-center rocket-lazyload lazyloaded"
        ...
        <div class="grid-container flex-box al-center">
          <div class="main-menu bdrs-20 overflow-y">
            <ul id="menu-main" class="ls-none m-0 main-nav">
              <li
                id="menu-item-349"
                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-309 current_page_item menu-item-349">
              ...
              <li
                id="menu-item-722"
                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-722">
              ...
              <li
                id="menu-item-2674"
                class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-2674">
                <a href="/#tin-tuc">Tin tức</a>
              </li>
              <li
                id="menu-item-1164"
                class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-1164">
                <a
                  href="/#doi-tac"
                  aria-current="page">Đối tác</a>
              </li>
              <li
                id="menu-item-566"
          ...
          <div class="menu-logo text-center">
            <svg
              ...
              <path
                class="path-secondary"
                d="m261.5 98.5h4.4v34.6h-4.4z"></path>
              <path
                class="path-secondary"
              ...
              <path
                class="path-secondary"
                d="m71 116.3h-55.1v-4.4h55.1z"></path>
              <path class="path-secondary" d="m350.5 112.4h57.8"></path>
              <path
                class="path-secondary"
                d="m408.3 116.3h-57.8v-4.4h57.8z"></path>
            </svg>
          </div>
        </div>
      </div>
