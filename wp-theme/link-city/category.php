                ...
                while (have_posts()) : the_post(); ?>
                    ...
                    <div class="post-item relative overflow-hidden bdrs-20 post-item-media">
                        <div class="img-wrap bdrs-20">
                            <svg class="p-middle ts-04" width="55" height="56" viewBox="0 0 55 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="27.5" cy="28" r="26.25" stroke="white" stroke-width="2.5"></circle>
                                <path d="M36.1561 26.6754L23.974 19.2304C23.7688 19.105 23.5338 19.0364 23.2934 19.0319C23.0529 19.0273 22.8155 19.0869 22.6057 19.2045C22.3959 19.3222 22.2213 19.4936 22.0997 19.7011C21.9781 19.9086 21.9141 20.1448 21.9141 20.3853V35.2766C21.9143 35.517 21.9785 35.7531 22.1001 35.9605C22.2217 36.1679 22.3963 36.3392 22.6061 36.4568C22.8158 36.5744 23.053 36.634 23.2934 36.6296C23.5338 36.6251 23.7687 36.5567 23.974 36.4315L36.1561 28.9865C36.354 28.8655 36.5175 28.6957 36.631 28.4933C36.7444 28.291 36.804 28.0629 36.804 27.8309C36.804 27.599 36.7444 27.3709 36.631 27.1686C36.5175 26.9662 36.354 26.7964 36.1561 26.6754V26.6754Z" stroke="white" stroke-width="2.5"></path>
                            </svg>
...
if ($max_pages > 1) : ?>
                <div class="btn btn-primary mx-auto load-more-posts" data-page="2" data-max="<?php echo esc_attr($max_pages); ?>" data-limit="9" data-tax="category" data-term="<?php echo get_queried_object_id(); ?>" data-target="post-grid" data-post-type="post">
                    <span>
